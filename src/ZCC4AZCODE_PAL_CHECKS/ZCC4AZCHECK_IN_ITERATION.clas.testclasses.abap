class test definition final for testing
  ...
  private section.
    constants test_class type c length 30 value 'ZCC4AZTEST_CHECK_IN_ITERATION'.
    constants:
...
class test implementation.
  method execute_test_class.
    ...
    cl_ci_atc_unit_driver=>create_asserter( )->check_and_assert(
              check             = new ZCC4AZCHECK_IN_ITERATION( )
              object            = value #( type = 'CLAS' name = test_class )
              expected_findings = value #( (
                                         code = ZCC4AZCHECK_IN_ITERATION=>finding_codes-check_in_iteration
                                         location = without_pseudo_comment_1
                                          quickfixes = value #(
                                          ( quickfix_code = ZCC4AZCHECK_IN_ITERATION=>quickfix_codes-if_quickfix
                                          location = without_pseudo_comment_1
                                          code = value #(
                                          ( `IF 1 <> 1 .` )
                                          ( `CONTINUE .` )
                                        ...
                                        (
                                         ...
                                         location = without_pseudo_comment_6
                                          ...
                                          ( quickfix_code = ZCC4AZCHECK_IN_ITERATION=>quickfix_codes-where_quickfix
