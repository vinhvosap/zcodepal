class ZCC4AZPROPER_BOOL_EXPRESSION definition
  public final
  create public.
  ...
  private section.
    ...
    methods process_declaration
      importing
        procedure type if_ci_atc_source_code_provider=>ty_procedure
        statement_idx type i
        declaration type ZCC4AZPROPER_BOOL_EXPRESSION=>ty_declaration
      returning value(findings) type if_ci_atc_check=>ty_findings.
endclass.

class ZCC4AZPROPER_BOOL_EXPRESSION implementation.
