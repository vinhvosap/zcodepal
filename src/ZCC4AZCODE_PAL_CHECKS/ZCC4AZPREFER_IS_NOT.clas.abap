class ZCC4AZPREFER_IS_NOT definition
  public
  final
  create public .
...
CLASS ZCC4AZPREFER_IS_NOT IMPLEMENTATION.
  ...
  method determine_finding.
    ...
    while current_index <= lines( statement-tokens ).
      ...
      if next_token is not initial
          and analyzer->is_bracket( next_token ) <> ZCC4AZIF_ABAP_ANALYZER=>bracket_type-opening.
        ...
        elseif next_token is not initial
            and analyzer->is_bracket( next_token ) = ZCC4AZIF_ABAP_ANALYZER=>bracket_type-closing.
          exit.
