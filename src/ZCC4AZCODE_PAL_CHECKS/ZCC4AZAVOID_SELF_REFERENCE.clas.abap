class ZCC4AZAVOID_SELF_REFERENCE definition
  public
  final
  create public .
  ...
  private section.
    ...
    types:
      begin of ty_method_definition,
        class type string,
        method type string,
        parameters type ZCC4AZIF_ABAP_ANALYZER=>ty_method_parameters,
    ...
    data analyzer type ref to ZCC4AZIF_ABAP_ANALYZER.
    ...
    methods load_method_from_parent
      importing
        ...
        method type string
      returning
        value(method_definition) type ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition.

ENDCLASS.



CLASS ZCC4AZAVOID_SELF_REFERENCE IMPLEMENTATION.
  ...
  method if_ci_atc_check~run.
    ...
    analyzer = ZCC4AZABAP_ANALYZER=>create( ).
  ...
  method remove_self_reference.
    ...
    endloop.
    data(flat_new_statement) = ZCC4AZABAP_ANALYZER=>create( )->flatten_tokens( new_statement-tokens ) && `.`.
    modified_statement = ZCC4AZABAP_ANALYZER=>create( )->break_into_lines( flat_new_statement ).
  endmethod.
ENDCLASS.
