class ZCC4AZMETHOD_SIGNATURE definition
  public
  final
  create public .
...
CLASS ZCC4AZMETHOD_SIGNATURE IMPLEMENTATION.
  ...
  method constructor.
    ...
    data(finding_codes) = value ZCC4AZCHECK_META_DATA=>ty_finding_codes(
  ...
  method is_bdef_impl_def.
    ...
    data(flat_statement) = ZCC4AZABAP_ANALYZER=>create( )->flatten_tokens( statement-tokens ).
