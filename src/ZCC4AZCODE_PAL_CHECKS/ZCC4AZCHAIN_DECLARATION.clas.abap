class ZCC4AZCHAIN_DECLARATION definition
  public
  final
  create public .
...
CLASS ZCC4AZCHAIN_DECLARATION IMPLEMENTATION.
    ...
    loop at statements assigning field-symbol(<statement>).
      ...
      case sy-tabix.
        ...
        when lines( statements ).
          ...
          flat_new_statement = ZCC4AZABAP_ANALYZER=>create( )->flatten_tokens( new_statement-tokens ) && `.`.
