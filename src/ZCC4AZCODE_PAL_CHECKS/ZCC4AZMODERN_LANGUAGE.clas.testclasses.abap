class test definition final for testing
  ...
  private section.
    constants test_class type c length 30 value 'ZCC4AZTEST_MODERN_LANGUAGE'.
    methods test for testing raising cx_static_check.
endclass.
class ZCC4AZMODERN_LANGUAGE definition local friends test.
...
class test implementation.
  ...
  method test.
    ...
    cl_ci_atc_unit_driver=>create_test_case(
      check = new ZCC4AZMODERN_LANGUAGE( )
      object = value #( type = 'CLAS' name = test_class )
    )->execute_and_assert( value #(

*      TRANSLATE
     ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-translate
...
*       READ
     ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-line_exists
       location = value #( object = test_read position = value #( line = 4 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-line_exists
...
*     ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-move
*       location = VALUE #( object = test_read position = VALUE #( line = 35 column = 4 ) )
*       quickfixes = VALUE #( (
*         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-move
...
*         code_lines = VALUE #( ( `idx = sy-tabix.` ) ) ) ) )
   ...
   ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-line_exists
    ...
    ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-prefer_new
       location = value #( object = test_create_object position = value #( line = 3 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-prefer_new
         span = value #( object = test_create_object from = 2 to = 3 )
         code_lines = value #( ( `DATA(object1) = NEW ZCC4AZTEST_MODERN_LANGUAGE( ).` ) ) ) ) )
   ...
   ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-prefer_new
    ...
    ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-call_method
       location = value #( object = test_call_method position = value #( line = 6 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-call_method
   ...
   ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-call_method
    ...
    ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-method_exporting
       location = value #( object = test_exporting_receiving position = value #( line = 6 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-method_exporting
    ...
    ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-exporting_receiving
       location = value #( object = test_exporting_receiving position = value #( line = 23 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-exporting_receiving
    ...
    ( code = ZCC4AZMODERN_LANGUAGE=>message_codes-text_assembly
       location = value #( object = test_text_assembly position = value #( line = 4 column = 4 ) )
       quickfixes = value #( (
         quickfix_code = ZCC4AZMODERN_LANGUAGE=>quickfix_codes-text_assembly
