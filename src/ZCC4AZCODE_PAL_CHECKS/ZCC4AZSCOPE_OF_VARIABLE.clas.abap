class ZCC4AZSCOPE_OF_VARIABLE definition
  public final
  create public.
  ...
  private section.
    ...
    methods analyze_standard_definition
      importing
         !statement type if_ci_atc_source_code_provider=>ty_statement
      returning
        value(info) type ZCC4AZSCOPE_OF_VARIABLE=>ty_definition.
    methods can_have_quickfixes
      importing
        ...
        value(usage_infos) type ZCC4AZSCOPE_OF_VARIABLE=>ty_usage_infos
      returning value(quickfix_info) type ty_quickfix_info.
    methods build_quickfixes
      importing
        procedure type if_ci_atc_source_code_provider=>ty_procedure
        statement_idx type i
        quickfix_info type ZCC4AZSCOPE_OF_VARIABLE=>ty_quickfix_info
        info type ZCC4AZSCOPE_OF_VARIABLE=>ty_definition
      returning
        value(quickfixes) type ref to cl_ci_atc_quickfixes.
endclass.

class ZCC4AZSCOPE_OF_VARIABLE implementation.
