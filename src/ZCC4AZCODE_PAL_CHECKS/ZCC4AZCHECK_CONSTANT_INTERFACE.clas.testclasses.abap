  ...
  private section.
    constants:
      begin of co_test_object,
        ...
        object_name_1 type if_ci_atc_check=>ty_object-name value 'ZCC4AZTEST_CHECK_CONSTANT_IF1',
        object_type_2 type if_ci_atc_check=>ty_object-type value 'INTF',
        object_name_2 type if_ci_atc_check=>ty_object-name value 'ZCC4AZTEST_CHECK_CONSTANT_IF2',
...
class ltcl_ implementation.
  ...
  method run_test_global_intf.
    ...
    data(finding_1_loc) = value if_ci_atc_check=>ty_location(
      object   = value #( name = 'ZCC4AZTEST_CHECK_CONSTANT_IF2=IU' type = 'PROG' )
      position = value #( line   = 1 column = 0 ) ).

    cl_ci_atc_unit_driver=>create_asserter( )->check_and_assert(
      check             = new ZCC4AZCHECK_CONSTANT_INTERFACE( )
      ...
      expected_findings = value #( ( code       = ZCC4AZCHECK_CONSTANT_INTERFACE=>finding_codes-cons_intf
  ...
  method run_test_local_intf.
    ...
    " Location of expected findings
    data(finding_1_loc) = value if_ci_atc_check=>ty_location(
      object = value #( name = 'ZCC4AZTEST_CHECK_CONSTANT_IF1=CCIMP' type = 'PROG' )
    ...
    cl_ci_atc_unit_driver=>create_asserter( )->check_and_assert(
      ...
      expected_findings = value #( ( code       = ZCC4AZCHECK_CONSTANT_INTERFACE=>finding_codes-cons_intf
                                     location   = finding_1_loc )
                                   ( code       = ZCC4AZCHECK_CONSTANT_INTERFACE=>finding_codes-cons_intf
