...
class key_words implementation.
  method statement_is_all_keywords.
    ...
    data(analyzer) = ZCC4AZABAP_ANALYZER=>create( ).
  ...
  method test_find_clause_index.
    ...
    data(index) = ZCC4AZABAP_ANALYZER=>create( )->find_clause_index( tokens = test_tokens clause = test_clause ).
    ...
    index = ZCC4AZABAP_ANALYZER=>create( )->find_clause_index( tokens = test_tokens clause = `A B C D` ).
    cl_abap_unit_assert=>assert_equals( act = index exp = 7 ).
    try.
        index = ZCC4AZABAP_ANALYZER=>create( )->find_clause_index( tokens = test_tokens clause = `   ` ).
        cl_abap_unit_assert=>fail( ).
      catch ZCC4AZCX_CLAUSE_IS_INITIAL.
    endtry.
  endmethod.
endclass.
...
class db_stmt definition final for testing
  ...
  private section.
    constants test_class type c length 30 value 'ZCC4AZTEST_FOR_DB_STATEMENTS'.
  ...
  method execute_test_class.
    ...
    cl_ci_atc_unit_driver=>create_asserter( )->check_and_assert(
      ...
      expected_findings = value #(
       ...
       ( code = 'SELECT' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 8 column = 4 ) ) )
       ( code = 'SELECT' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 9 column = 4 ) ) )
       ( code = 'DELETE' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 13 column = 4 ) ) )
       ( code = 'DELETE' parameters = value #( param_1 = 'ZCC4AZDB_TEST2' param_2 = 'ZCC4AZDB_TEST1' )
       ...
       ( code = 'INSERT' parameters = value #( param_1 = 'ZCC4AZDB_TEST2' param_2 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 23 column = 4 ) ) )
       ( code = 'UPDATE' parameters = value #( param_1 = 'ZCC4AZDB_TEST2' param_2 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 29 column = 4 ) ) )
       ( code = 'UPDATE' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 30 column = 4 ) ) )
       ( code = 'UPDATE' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
         location = value #( object = mixed position = value #( line = 31 column = 4 ) ) )
       ( code = 'MODIFY' parameters = value #( param_1 = 'ZCC4AZDB_TEST1' )
...
class method_definitions implementation.
  method method_definitions.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
        name = `METH`
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
        name = `METH`
        parameters = value #( ( name = `PAR` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-importing ) ) ) ).
    cl_abap_unit_assert=>assert_equals(
      act = analyzer->parse_method_definition(
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
        name = `METH`
        parameters = value #( ( name = `PAR` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-exporting ) ) ) ).
    cl_abap_unit_assert=>assert_equals(
      act = analyzer->parse_method_definition(
        shared=>tokenize( `methods meth changing par type i .` ) )
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
        name = `METH`
        parameters = value #( ( name = `PAR` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-changing ) ) ) ).
    cl_abap_unit_assert=>assert_equals(
      act = analyzer->parse_method_definition(
        shared=>tokenize( `methods meth changing par type i .` ) )
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZIF_ABAP_ANALYZER=>ty_method_definition(
        name = `METH`
        parameters = value #(
          ( name = `IMP` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-importing )
          ( name = `EXP` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-exporting )
          ( name = `CH` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-changing )
          ( name = `RET` kind = ZCC4AZIF_ABAP_ANALYZER=>parameter_kind-returning ) ) ) ).
  endmethod.
endclass.
...
class ZCC4AZABAP_ANALYZER definition local friends flatten_tokens.
...
*            123456789012345678901234567890123456
    data(lines) = new ZCC4AZABAP_ANALYZER( )->_break_into_lines( code = flat break_at = 20 ).
  ...
  method test_line_break.
    ...
    try.
        lines = new ZCC4AZABAP_ANALYZER( )->_break_into_lines( code = `12345678901` break_at = 10 ).
        cl_abap_unit_assert=>fail( `Exception expected` ).
      catch ZCC4AZCX_LINE_BREAK_IMPOSSIBLE.
*     expected
    endtry.
    try.
        lines = new ZCC4AZABAP_ANALYZER( )->_break_into_lines( code = `1234567890 123467890123` break_at = 10 ).
        cl_abap_unit_assert=>fail( `Exception expected` ).
      catch ZCC4AZCX_LINE_BREAK_IMPOSSIBLE.
*     expected
    endtry.
    ...
    try.
        lines = new ZCC4AZABAP_ANALYZER( )->_break_into_lines( code = `|23456789| blabla` break_at = 10 ).
...
class ZCC4AZABAP_ANALYZER definition local friends logical_expressions.

class logical_expressions implementation.

  method no_nesting.
    data(analyzer) = new ZCC4AZABAP_ANALYZER( ).
    cl_abap_unit_assert=>assert_equals(
      act = analyzer->parse_logical_expression(
        shared=>tokenize( `A = 1` )-tokens )
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
  ...
  method once_connected.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 2 right = 3
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-or left = 2 right = 3
          tokens = value #( from = 5 to = 5 ) )
        ( tokens = value #( from = 1 to = 4 ) )
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 2 right = 3
          tokens = value #( from = 4 to = 4 ) )
        ( tokens = value #( from = 1 to = 3 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 4 right = 5
  ...
  method negations.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-not left = 2
  ...
  method nested.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-or left = 2 right = 5
          tokens = value #( from = 10 to = 10 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 3 right = 4
          tokens = value #( from = 5 to = 5 ) )
        ( tokens = value #( from = 2 to = 4 ) )
        ( tokens = value #( from = 6 to = 8 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 6 right = 7
  ...
  method nested_2.
    ...
    cl_abap_unit_assert=>assert_equals(
      ...
      exp = value ZCC4AZABAP_ANALYZER=>ty_logical_expression(
        ...
        ( tokens = value #( from = 2 to = 4 ) )
        ( tokens = value #( from = 6 to = 8 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 6 right = 9
          tokens = value #( from = 20 to = 20 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-and left = 7 right = 8
          tokens = value #( from = 15 to = 15 ) )
        ( tokens = value #( from = 12 to = 14 ) )
        ( tokens = value #( from = 16 to = 18 ) )
        ( connective = ZCC4AZIF_ABAP_ANALYZER=>logical_connective-or left = 10 right = 11
