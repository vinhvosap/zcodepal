class ZCC4AZCHECK_META_DATA definition
  public
  final
  create private.

  public section.
    interfaces ZCC4AZIF_CHECK_META_DATA.
    ...
    class-methods create
      ...
      returning value(result) type ref to ZCC4AZIF_CHECK_META_DATA.
    methods constructor
      importing meta_data type ty_meta_data.
...
class ZCC4AZCHECK_META_DATA implementation.
  ...
  method create.
    result = new ZCC4AZCHECK_META_DATA( meta_data ).
  endmethod.
  ...
  method ZCC4AZIF_CHECK_META_DATA~has_valid_pseudo_comment.
