...
class ZCC4AZABAP_ANALYZER definition local friends db_statement_analyzer.
class db_statement_analyzer definition final.
  public section.
    ...
    methods constructor
      importing
        ...
        start_idx          type i
        analyzer           type ref to ZCC4AZABAP_ANALYZER
        include_subqueries type abap_bool.
    methods analyze
      returning value(result) type ZCC4AZIF_ABAP_ANALYZER=>ty_db_statement.
  ...
  private section.
    ...
    data analyzer             type ref to ZCC4AZABAP_ANALYZER.
