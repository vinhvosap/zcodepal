...
class impl_interface definition.
  public section.
    interfaces ZCC4AZIF_TEST_AVOID_SELF_REF.
  private section.
    data var_1 type i.
endclass.
...
class impl_interface implementation.
  ...
  method ZCC4AZIF_TEST_AVOID_SELF_REF~meth_1.
    me->var_1 = var_1.
  endmethod.

endclass.

class inheriting_from_global definition inheriting from ZCC4AZTEST_AVOID_SELF_REF_SUP.
  public section.
