class ZCC4AZTEST_MODERN_LANGUAGE definition
  public
  final
  create public .
...
class ZCC4AZTEST_MODERN_LANGUAGE implementation.
...
*    MOVE a TO b.                                    "#EC DEPRECATED_KEY
  ...
  method test_read.
    data itab type standard table of ZCC4AZDB_TEST1 with non-unique sorted key name components obj_name.
...
*    MESSAGE i011(sci) INTO DATA(lv_dummy) WITH sy-tabix ##NEEDED.
  ...
  method test_loop.
    data itab type standard table of ZCC4AZDB_TEST1.
...
*    WRITE l_entry-pgmid.
  ...
  method test_create_object.
    data object1 type ref to ZCC4AZTEST_MODERN_LANGUAGE.
